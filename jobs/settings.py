...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "class": "logging.handlers.TimedRotatingFileHandler",  # Use a time-based rotating file handler
            ...
            "backupCount": 100,  # Keep up to 100 backup log files
        }
    },
    "loggers": {
        "django": {"handlers": ["file"], "level": "INFO", "propagate": True},  # Django logger settings
        "project": {"handlers": ["file"], "level": "INFO", "propagate": True},  # Project-specific logger settings
        "": {"handlers": ["file"], "level": "INFO", "propagate": True},  # Root logger settings
    },
}
...
if ENABLE_PROMETHEUS:
    ...
    EMAIL_USE_TLS = True
    EMAIL_PORT = 587
    EMAIL_HOST_USER = 'nallapanenimahidhar2004@gmail.com'  # sender's email-id
    EMAIL_HOST_PASSWORD = 'smsfnbompqfhupjy'  # password associated with above email-id
